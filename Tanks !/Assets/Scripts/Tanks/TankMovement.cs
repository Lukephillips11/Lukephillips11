...
public class TankMovement : MonoBehaviour
{
    ...
    private float m_TurnInputValue;                  // the current value of turn imput
    ...
    {
        // when the tank is turned off, set it to kinematic so it stops working
    ...
    private void Move()
    {
        ...
        // based on the input, speed and time within frames
    ...
    private void Turn()
    {
        // determine the number of degrees to be turned based on input,
